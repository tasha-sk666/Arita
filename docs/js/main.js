...
/* harmony import */ var _components_start_animation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/start-animation */ "./src/js/components/start-animation.js");
/* harmony import */ var _components_mouse__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/mouse */ "./src/js/components/mouse.js");
/* harmony import */ var _components_bg_slides__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/bg-slides */ "./src/js/components/bg-slides.js");
/* harmony import */ var _components_images_slides__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/images-slides */ "./src/js/components/images-slides.js");
/* harmony import */ var _components_text_slides__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/text-slides */ "./src/js/components/text-slides.js");
/* harmony import */ var _components_shapes_slidest__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/shapes-slidest */ "./src/js/components/shapes-slidest.js");
/* harmony import */ var _components_script__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/script */ "./src/js/components/script.js");
...
/* harmony export */   "bgItems": () => (/* binding */ bgItems),
/* harmony export */   "easing": () => (/* binding */ easing),
/* harmony export */   "helperInput": () => (/* binding */ helperInput),
/* harmony export */   "imageSlides": () => (/* binding */ imageSlides),
/* harmony export */   "links": () => (/* binding */ links),
/* harmony export */   "mainSection": () => (/* binding */ mainSection),
/* harmony export */   "shapes": () => (/* binding */ shapes),
/* harmony export */   "shapesItem": () => (/* binding */ shapesItem),
/* harmony export */   "slideBg": () => (/* binding */ slideBg),
/* harmony export */   "startComplite": () => (/* binding */ startComplite),
/* harmony export */   "startingTl": () => (/* binding */ startingTl)
/* harmony export */ });
...
var shapesItem = document.querySelectorAll('.shapes__item');
var helperInput = document.querySelector('#helper-input');
var links = document.querySelectorAll('a');
var easing = '0.77, 0.125, 0.265, 1.04';
var startComplite = function startComplite() {
  imageSlides.forEach(function (el) {
    el.style.opacity = 1;
  });
  shapesItem.forEach(function (el) {
    el.style.opacity = 1;
  });
};
...
/* harmony import */ var _vendor_gsap_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/gsap.min */ "./src/js/vendor/gsap.min.js");
/* harmony import */ var _vendor_gsap_min__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_gsap_min__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _vendor_swiped_events__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/swiped-events */ "./src/js/vendor/swiped-events.js");
/* harmony import */ var _vendor_swiped_events__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_vendor_swiped_events__WEBPACK_IMPORTED_MODULE_2__);
...
/***/ "./src/js/components/bg-slides.js":
/*!****************************************!*\
  !*** ./src/js/components/bg-slides.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "bgSlides": () => (/* binding */ bgSlides)
/* harmony export */ });
/* harmony import */ var _settings_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../_settings.js */ "./src/js/_settings.js");

var slidesCount = 5;
var slideCounter = 1;
_settings_js__WEBPACK_IMPORTED_MODULE_0__.shapes.forEach(function (el) {
  el.style.backgroundColor = "".concat(el.dataset.bg);
});
_settings_js__WEBPACK_IMPORTED_MODULE_0__.bgItems.forEach(function (el) {
  el.style.backgroundImage = "url(".concat(el.dataset.bg, ")");
});
var bgSlides = function bgSlides(direction) {
  var itemClass = "slide-".concat(slideCounter);

  if (direction == 'down') {
    if (slideCounter < slidesCount) {
      _settings_js__WEBPACK_IMPORTED_MODULE_0__.mainSection.classList.remove(itemClass);
      slideCounter++;
      itemClass = "slide-".concat(slideCounter);
      _settings_js__WEBPACK_IMPORTED_MODULE_0__.mainSection.classList.add(itemClass);
    }
...
/***/ "./src/js/components/images-slides.js":
/*!********************************************!*\
  !*** ./src/js/components/images-slides.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "imagesSlidesScroll": () => (/* binding */ imagesSlidesScroll)
/* harmony export */ });
/* harmony import */ var _settings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../_settings */ "./src/js/_settings.js");

var imagesSlidesScroll = function imagesSlidesScroll(direction) {
  var imageSlides = document.querySelectorAll('.slide-bg__inner');
  var currentSlide = document.querySelector('.slide-bg__inner--active');
  var nextSlide;
  direction == 'down' ? nextSlide = currentSlide.nextElementSibling : nextSlide = currentSlide.previousElementSibling;

  if (nextSlide) {
    imageSlides.forEach(function (el) {
      el.classList.remove('slide-bg__inner--index');
    });
    currentSlide.classList.add('slide-bg__inner--index');
    var tl = gsap.timeline({
      default: {
        ease: _settings__WEBPACK_IMPORTED_MODULE_0__.easing
      },
...
function moveMouse(e) {
  if (e.clientX < 5 || e.clientY < 5 || e.clientY > window.innerHeight - 5 || e.clientX > window.innerWidth - 5) {
    ...
    mouse.style.transform = "translate(".concat(e.clientX - 15, "px, ").concat(e.clientY - 15, "px)");
  }
}
...
if (window.innerWidth >= 768) {
  ...
  _settings__WEBPACK_IMPORTED_MODULE_0__.slideBg.addEventListener('mouseover', function () {
    mouse.classList.add('view-visible');
  });
  _settings__WEBPACK_IMPORTED_MODULE_0__.slideBg.addEventListener('mouseleave', function () {
    mouse.classList.remove('view-visible');
  });
  _settings__WEBPACK_IMPORTED_MODULE_0__.links.forEach(function (link) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _settings_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../_settings.js */ "./src/js/_settings.js");
/* harmony import */ var _bg_slides_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./bg-slides.js */ "./src/js/components/bg-slides.js");
/* harmony import */ var _images_slides_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./images-slides.js */ "./src/js/components/images-slides.js");
/* harmony import */ var _shapes_slidest_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./shapes-slidest.js */ "./src/js/components/shapes-slidest.js");
/* harmony import */ var _start_animation_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./start-animation.js */ "./src/js/components/start-animation.js");
/* harmony import */ var _text_slides_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./text-slides.js */ "./src/js/components/text-slides.js");
...
var init = function init() {
  window.onload = function () {
    ...
    _images_slides_js__WEBPACK_IMPORTED_MODULE_2__.imagesSlidesScroll;
    setTimeout(function () {
      (0,_start_animation_js__WEBPACK_IMPORTED_MODULE_4__.startAnimation)();
      preloader.classList.add('preloader-none');
    }, 2700);
  };

  var showNextSlide = function showNextSlide() {
    (0,_bg_slides_js__WEBPACK_IMPORTED_MODULE_1__.bgSlides)('down');
    (0,_images_slides_js__WEBPACK_IMPORTED_MODULE_2__.imagesSlidesScroll)('down');
    (0,_text_slides_js__WEBPACK_IMPORTED_MODULE_5__.textSlides)('down');
    (0,_shapes_slidest_js__WEBPACK_IMPORTED_MODULE_3__.shapesSlides)('down');
  };

  var showPrevSlide = function showPrevSlide() {
    (0,_bg_slides_js__WEBPACK_IMPORTED_MODULE_1__.bgSlides)('up');
    (0,_images_slides_js__WEBPACK_IMPORTED_MODULE_2__.imagesSlidesScroll)('up');
    (0,_text_slides_js__WEBPACK_IMPORTED_MODULE_5__.textSlides)('up');
    (0,_shapes_slidest_js__WEBPACK_IMPORTED_MODULE_3__.shapesSlides)('up');
  };
  ...
  if (window.innerWidth >= 768) {
    window.addEventListener('wheel', function (e) {
      ...
      if (delta > 0) {
        if (_settings_js__WEBPACK_IMPORTED_MODULE_0__.helperInput.value == '1') {
          _settings_js__WEBPACK_IMPORTED_MODULE_0__.helperInput.value = 0;
          showPrevSlide();
          setTimeout(function () {
            _settings_js__WEBPACK_IMPORTED_MODULE_0__.helperInput.value = 1;
          }, 1500);
        }
      } else {
        if (_settings_js__WEBPACK_IMPORTED_MODULE_0__.helperInput.value == '1') {
...
/***/ "./src/js/components/shapes-slidest.js":
/*!*********************************************!*\
  !*** ./src/js/components/shapes-slidest.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var shapesSlides = function shapesSlides(direction) {
  var currentSlide = document.querySelector('.shapes__item--active');
  var nextSlide;
  direction == 'down' ? nextSlide = currentSlide.nextElementSibling : nextSlide = currentSlide.previousElementSibling;

  if (nextSlide) {
    _settings__WEBPACK_IMPORTED_MODULE_0__.shapesItem.forEach(function (el) {
    ...
    currentSlide.classList.remove('shapes__item--active');
...
/***/ "./src/js/components/start-animation.js":
/*!**********************************************!*\
  !*** ./src/js/components/start-animation.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var startAnimation = function startAnimation() {
  var currentSlide = document.querySelector('.slide-bg__inner--active');
  var currentShapes = document.querySelector('.shapes__item--active');
  var currentText = document.querySelector('.slides-container__slide--active');
  _settings__WEBPACK_IMPORTED_MODULE_0__.startingTl.to('.header', 0.5, {
    opacity: 1,
    y: 0,
    delay: 0.5
    ...
    xPercent: 100
  }, '-=0.2').from(currentSlide.querySelector('.shapes__content'), 0.6, {
    xPercent: -100,
    delay: -0.6
  }, '-=0.2');
};
...
/***/ "./src/js/components/text-slides.js":
/*!******************************************!*\
  !*** ./src/js/components/text-slides.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var textSlides = function textSlides(direction) {
  var currentSlide = document.querySelector('.slides-container__slide--active');
  var nextSlide;
  direction == 'down' ? nextSlide = currentSlide.nextElementSibling : nextSlide = currentSlide.previousElementSibling;
...
/***/ "./src/js/vendor/swiped-events.js":
/*!****************************************!*\
  !*** ./src/js/vendor/swiped-events.js ***!
  \****************************************/
/***/ (() => {
